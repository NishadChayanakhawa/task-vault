...
/**
 * Test class for Resource configuration API integration tests using Cucumber
 * and TestNG.
 * <p>
 ...
 * the API endpoints related to Resource configuration.
 * </p>
 */
@CucumberOptions(
		// Specifies the location of the Cucumber feature files that contain the API
		// test scenarios.
		features = "src/test/resources/features/ResourceConfigurationApiTests.feature",
...
public class ResourceConfigurationApiIT extends AbstractTestNGCucumberTests {
