...
/**
 * Test class for TaskGroup configuration API integration tests using Cucumber
 * and TestNG.
 * <p>
 ...
 * the API endpoints related to TaskGroup configuration.
 * </p>
 */
@CucumberOptions(
		// Specifies the location of the Cucumber feature files that contain the API
		// test scenarios.
		features = "src/test/resources/features/TaskGroupConfigurationApiTests.feature",
...
public class TaskGroupConfigurationApiIT extends AbstractTestNGCucumberTests {
