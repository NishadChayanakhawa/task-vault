...
/**
 * Test class for Task configuration API integration tests using Cucumber and
 * TestNG.
 * <p>
 ...
 * the API endpoints related to Task configuration.
 * </p>
 */
@CucumberOptions(
		// Specifies the location of the Cucumber feature files that contain the API
		// test scenarios.
		features = "src/test/resources/features/TaskApiTests.feature",
...
public class TaskApiIT extends AbstractTestNGCucumberTests {
